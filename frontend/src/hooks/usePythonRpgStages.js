...
export default function usePythonRpgStages(gameId) {
    ...
    const completeStage = useCallback(
        async (stageId) => {
            ...
            console.log("📤 Sending complete request for stage:", stageId, "game:", gameId);
