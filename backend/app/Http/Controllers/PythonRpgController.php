...
class PythonRpgController extends Controller
{
    /**
     * Liste des niveaux
     */
    ...
    {
        $stage = PythonRpgStage::findOrFail($id);
    ...
    public function complete(Request $request)
    {
        ...
        $stage = PythonRpgStage::findOrFail(
            $request->stage_id
        );
